...
import { Await, Link, Navigate, Outlet, useAsyncValue, useLoaderData } from "react-router-dom";
...
const SongList = () => {
  ...
  const list = typeof songs !== "string" ? songs.map((song) => {
    return (
